  ...
  return (
    <div className="glass-card" style={{ borderRadius: 28, padding: "40px 36px" }}>
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 26, fontWeight: 700, color: "#1a1a2e", marginTop: 24, marginBottom: 6 }}>Create your account</h1>
        <p style={{ fontSize: 14, color: "#6b7280" }}>Join thousands of creators</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        {[
          ...
          <div key={key} style={{ marginBottom: 16 }}>
            ...
            <input type={type} required className="craft-input" placeholder={placeholder}
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div style={{ position: "relative" }}>
            <input type={showPw ? "text" : "password"} required className="craft-input"
