...
export default function PrintingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F5E9DA" }}>
      {/* Hero */}
      <div style={{ background: "linear-gradient(135deg, #FDF6EE 0%, #EDD9C5 100%)", borderBottom: "1px solid #fde68a40", padding: "60px 24px 56px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(32px,5vw,52px)", fontWeight: 700, color: "#2C1A0E", marginBottom: 16 }}>
            3D Printing <span style={{ color: "#C97B63" }}>Service</span>
          </h1>
          <p style={{ fontSize: 17, color: "#8B6F5E", maxWidth: 560, margin: "0 auto", lineHeight: 1.65 }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20, marginBottom: 72 }}>
          {features.map((f) => (
            <div key={f.title} className="glass-card" style={{ padding: 24, borderRadius: 20 }}>
              ...
              <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 16, fontWeight: 600, color: "#2C1A0E", marginBottom: 6 }}>{f.title}</h3>
              <p style={{ fontSize: 13, color: "#8B6F5E", lineHeight: 1.55 }}>{f.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: 32, fontWeight: 700, color: "#2C1A0E", textAlign: "center", marginBottom: 8 }}>
            Submit a Print Request
          </h2>
          <p style={{ textAlign: "center", color: "#8B6F5E", marginBottom: 40 }}>Fill out the form and we'll get back to you with a quote within 24 hours.</p>

          {submitted ? (
            <div style={{ textAlign: "center", padding: "60px 24px", background: "rgba(253,246,238,0.6)", borderRadius: 24, border: "1px solid rgba(201,123,99,0.15)" }}>
              ...
              <p style={{ color: "#8B6F5E", marginBottom: 24 }}>Our team will review your request and contact you within 24 hours with pricing and timeline.</p>
            ...
            <form onSubmit={handleSubmit} className="glass-card" style={{ padding: "36px", borderRadius: 24 }}>
              ...
              <div style={{ display: "grid", gap: 18 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  <div>
                    <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#5C3D2E", marginBottom: 6 }}>Material</label>
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#5C3D2E", marginBottom: 6 }}>Color</label>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#5C3D2E", marginBottom: 6 }}>Phone</label>
