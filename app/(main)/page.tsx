  ...
  return (
    <div style={{ background: "#F5E9DA" }}>
      ...
      <section style={{
        ...
        {/* Keep subtle SVG overlays on top */}
        <DotGrid style={{ position: "absolute", top: "12%", left: "6%", pointerEvents: "none", zIndex: 1 }} />
        <DotGrid style={{ position: "absolute", bottom: "14%", right: "8%", pointerEvents: "none", zIndex: 1 }} />
        <SketchCircle style={{ position: "absolute", top: "8%", right: "12%", pointerEvents: "none", zIndex: 1 }} />
        <SketchCircle style={{ position: "absolute", bottom: "20%", left: "3%", pointerEvents: "none", width: 80, height: 80, zIndex: 1 }} />
